...
# -----------------------------------
# 3D Skeleton Display       NTU-60 RBG + D dataset Visualization
# Author: DuohanL
# Date: 2020/2/10 @home
# -----------------------------------
...
class Draw3DSkeleton(object):
    ...
    def __init__(self, file, save_path=None, init_horizon=-45,
                 ...
                 y_rotation=None, pause_step=0.0005):
...
if __name__ == '__main__':
    # test sample
    sk = Draw3DSkeleton("/Users/walidajalil/Hi-TRS/data/nturgb+d_skeletons/S001C001P001R001A038.skeleton", './a08')
    sk.visual_skeleton()
